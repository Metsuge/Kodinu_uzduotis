        ...
        <div className='trend-content-list' >
           <div className='trend-container' >
                <ul className='component-trend'>
                    <li><img alt='Chineese new year - The year of the Dog' src={dogyear}></img></li>
                ...
                <ul className='component-trend'>
                    <li><img alt='Birds, beasts and beauties of Bangladesh' src={trendingelephant}></img></li>
                    <div className='trend-text'>
                ...
                <ul className='component-trend'>
                    <li><img alt='The Empty Quarter Desert - Rub al Khali' src={rubalkhali}></img></li>
                    <div className='trend-text'>
